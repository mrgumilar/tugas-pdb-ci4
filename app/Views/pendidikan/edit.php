...
<div class="modal fade" id="modaledit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <?= form_open('pendidikan/updatependidikan', ['class' => 'formedit']) ?>
            <?= csrf_field(); ?>
            <div class="modal-body">
                <input type="hidden" class="form-control" id="pendidikan_id" value="<?= $pendidikan_id ?>"
                    name="pendidikan_id" readonly>
                <div class="form-group row">
                    <label for="" class="col-sm-4 col-form-label">Nama pendidikan</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="nama_pendidikan" value="<?= $nama_pendidikan ?>"
...
$(document).ready(function() {
    $('.formedit').submit(function(e) {
        ...
        $.ajax({
            ...
            data: {
                pendidikan_id: $('input#pendidikan_id').val(),
