...
<div class="modal fade" id="modaledit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <?= form_open('agama/updateagama', ['class' => 'formedit']) ?>
            <?= csrf_field(); ?>
            <div class="modal-body">
                <input type="hidden" class="form-control" id="agama_id" value="<?= $agama_id ?>"
                    name="agama_id" readonly>
                <div class="form-group row">
                    <label for="" class="col-sm-4 col-form-label">Nama agama</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="nama_agama" value="<?= $nama_agama ?>"
                            name="nama_agama">
